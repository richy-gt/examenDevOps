...
## Objetivo 
Demostrar la integracion entre frontend, backend, base de datos y contenedores, utilizando buenas 
practicas de desarrollo y despliegue con Docker. 
...
El archivo docker-compose.yml define las credenciales y parametros de conexion para la base de 
datos y los servicios backend.
